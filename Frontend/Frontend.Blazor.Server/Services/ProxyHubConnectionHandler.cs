...
internal class ProxyHubConnectionHandler<THub> : HubConnectionHandler<THub> where THub : Hub
{
    ...
    public ProxyHubConnectionHandler(HubLifetimeManager<THub>                 lifetimeManager,
            ...
            : base(lifetimeManager, protocolResolver, globalHubOptions, hubOptions, loggerFactory, userIdProvider, serviceScopeFactory) => storageContainerInitializer = storageContainerAccessor;
